...
class f {
    ...
    _map = {};
    static forEach(e) {
        r().forEach(f._channelMessages, e);
    }
    static get(e) {
    ...
    getManyAfter(e, t, n) {
        ...
        if (-1 === r) return null;
        let a = [];
        for (let e = r + 1; e < this.length && (-1 === t || a.length < t); e++)
    ...
    getManyBefore(e, t, n) {
        ...
        if (-1 === r) return null;
        let a = [];
        for (let e = r - 1; e >= 0 && (-1 === t || a.length < t); e--)
    ...
    addCachedMessages(e, t) {
        ...
        this._array
            ...
            .forEach((e) => u(n, e, (e, t) => c.default.compare(e.id, t.id)));
        let i = !t && this.cached;
