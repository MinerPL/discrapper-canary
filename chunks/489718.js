...
function L(e) {
    let t,
        ...
        k = r.useRef(null),
        F = w ?? k,
        B = (0, o.H)({ isSelected: n, onChange: v ?? R, isDisabled: L }),
        {
            inputProps: V,
            labelProps: H,
            isPressed: j,
        } = (0, a.K)({ id: D, isDisabled: L, "aria-describedby": P, "aria-labelledby": U ?? "" }, B, F),
        ...
        X = (0, u.r)(d.A.colors.SWITCH_BACKGROUND_ACTIVE).spring(),
        q = (0, u.r)(d.A.colors.SWITCH_BORDER_DEFAULT).spring(),
        Z = (0, u.r)(d.A.colors.SWITCH_BORDER_SELECTED_DEFAULT).spring(),
    ...
    let ed = (0, i.jsx)(l.animated.div, {
        ...
        style: {
            opacity: el,
            backgroundColor: es.to({ range: N, output: [Y ? Q : K, $, X, Y ? J : z], extrapolate: "clamp" }),
            border: "1px solid",
            borderColor: es.to({
                range: N,
                output: [Y ? ee : q, Y ? ee : q, Y ? et : Z, Y ? et : Z],
                extrapolate: "clamp",
            }),
        },
    ...
    return y
        ...
        : (0, i.jsx)(E.vN, {
              ...
              children: (0, i.jsxs)("label", {
                  ...
                  children: [ed, (0, i.jsx)(A.A, { children: (0, i.jsx)("input", { ...V, ref: F }) })],
              }),
          });
}
