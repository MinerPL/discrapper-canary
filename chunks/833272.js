...
let t = (function () {
    var e = {
            ...
            convert: {
                fromCodePoint: function (e) {
                    var s = "string" == typeof e ? parseInt(e, 16) : e;
                    return s < 65536 ? o(s) : o(55296 + ((s -= 65536) >> 10), 56320 + (1023 & s));
                },
                toCodePoint: f,
            },
            onerror: function () {
                this.parentNode && this.parentNode.replaceChild(_(this.alt, !1), this);
            },
            parse: function (s, t) {
                var i;
                return (
                    ...
                    ("string" == typeof s
                        ...
                        : function (e, s) {
                              for (
                                  ...
                                  for (
                                      a = !1, o = document.createDocumentFragment(), m = (d = k[b]).nodeValue, c = 0;
                                      (g = n.exec(m));
                                  ) {
                                      if (
                                          ((f = g.index) !== c && o.appendChild(_(m.slice(c, f), !0)),
                                          (l = u((p = g[0]))),
                                          (c = f + p.length),
                                          (v = s.callback(l, s)),
                                          l && v)
                                      ) {
                                          for (i in (((h = new Image()).onerror = s.onerror),
                        ...
                        attributes: "function" == typeof t.attributes ? t.attributes : g,
                        base: "string" == typeof t.base ? t.base : e.base,
                        ext: t.ext || e.ext,
                        size: t.folder || ("number" == typeof (i = t.size || e.size) ? i + "x" + i : i),
    ...
    return e;
    function _(e, s) {
        return document.createTextNode(s ? e.replace(t, "") : e);
    }
    function d(e, s) {
        return "".concat(s.base, s.size, "/", e, s.ext);
    }
    function u(e) {
        return f(0 > e.indexOf(i) ? e.replace(t, "") : e);
    }
    function m(e) {
        return s[e];
    }
