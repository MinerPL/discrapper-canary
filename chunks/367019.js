!(function () {
    ...
    ((d.BUFFER_SIZE = 4096),
        ...
        (d.test = function (t) {
            return (
                "string" == typeof t && /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(t)
            );
        }),
        "u" > typeof crypto ? (e = crypto) : "u" > typeof window && void 0 !== window.msCrypto && (e = window.msCrypto),
        (e = e || a(375385)),
        (t.exports = d),
