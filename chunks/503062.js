...
function y(e) {
    let { user: s, status: i, guildId: u, channelId: M, onSelect: y } = e,
        { theme: D, themeType: R } = (0, b.E)(),
        L = l.useMemo(() => s.isNonUserBot() || (0, E.c)(s, M), [s, M]),
    ...
    return (0, n.jsxs)(c.D, {
        ...
        children: [
            (0, n.jsx)(g.A, { nameplate: O ? Z : null, hovered: O, content: V, placement: I.u.MUTUAL_FRIENDS_LIST }),
            (0, n.jsxs)("div", {
                ref: V,
                className: j.Qs,
                children: [
