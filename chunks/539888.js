...
function y(e) {
    let { width: t } = e;
    return (0, i.jsx)("div", { className: j.M0, style: { width: t } });
}
function b(e) {
    let { rank: t, row: l } = e;
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)("img", { className: j.my, src: l.avatar, alt: "", "aria-hidden": !0 }),
            (0, i.jsxs)("div", {
                className: j.n_,
                "aria-hidden": !0,
                children: [
...
function C() {
    return (0, i.jsx)("div", { className: j.kL, children: I.map((e, t) => (0, i.jsx)(b, { rank: t + 1, row: e }, t)) });
}
var N = l(189213),
    D = l(192308),
    T = l(977756),
    ...
    return (0, i.jsxs)(h.B, {
        ...
        children: [
            (0, i.jsxs)(h.B, {
                ...
                gap: 12,
                children: [
                    null != a ? (0, i.jsx)(a, { alt: "", ariaHidden: !0 }) : (0, i.jsx)(C, {}),
                    (0, i.jsxs)(h.B, {
                        align: "center",
                        gap: 4,
                        children: [
...
function B(e) {
    ...
    let { View: x, Edit: E } = h,
        A = "edit" === a,
        p = null != E && null != c && null == f;
    return (0, i.jsxs)("div", {
        className: s()(R.kL, { [R.Dy]: A }),
        children: [
            A
                ? (0, i.jsx)(L, { title: g, disabled: o, dragHandleRef: u, canEdit: p, onEdit: m, onRemove: d })
                : (0, i.jsx)(k, { title: g }),
            (0, i.jsx)("div", {
                className: R.rf,
                children:
