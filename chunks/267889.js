...
var e6 = (((i = {})[(i.PREMIUM = 0)] = "PREMIUM"), (i[(i.ROLE_SUBSCRIPTION = 1)] = "ROLE_SUBSCRIPTION"), i),
    e7 = n(342379);
let e5 = "expression-guild-",
    { itemIdForIndex: e4 } = (0, ek.J)(e5),
        ...
        g = (0, s.jsxs)(H.D, {
            ...
            children: [
                null != p
                    ...
                    : null,
                null == p && null != m
                    ? (0, s.jsx)(eq, { categoryId: m, className: e7.Yl, height: tt, width: tt, size: "custom" })
                    : null,
            ],
        }),
        x = i[n + 1],
        ...
        children: (e) =>
            ...
            (0, s.jsx)(
                H.D,
                {
                    ...
                    className: o()(e7.KB, { [e7.h_]: !T }),
                    tabIndex: T ? 0 : -1,
                    onClick: () => M(e),
                    children: (0, s.jsx)(eM.n, { size: "custom", color: "currentColor", height: tt, width: tt }),
                },
                w,
            ),
    });
                ...
                ? (0, s.jsx)(nR, {
                      ...
                      onClick: (e) => {
                          if (
                              ...
                              ((t.x = _.x + (P + 1) * k), T(`${P}:${a}`), (0, nC.h)(S, e, L.id, t));
                          }
                          !(function (e) {
...
let nk = (0, ec.xI)(f.A.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_TOP),
    ...
    nF = r.memo(function (e) {
        let t,
            ...
            [K, Z] = r.useState(!1),
            {
                ...
                let {
                    ...
                    j = (0, A.p)(),
                    b = r.useRef(Q.An1),
                    T = r.useMemo(() => ("" !== n ? tO.A.convert.toCodePoint(n) : ""), [n]),
                    R = r.useCallback(
                        (e) => {
                            let t = d[e],
                                n = d[e + 1];
                        ...
                        () =>
                            eR().memoize((e) => {
                                ...
                                return (0, s.jsx)(
                                    t4.A,
                                    {
                                        className: o()(nL.wx, v, { [nL.RA]: f, [nL.sp]: p }),
                                        icon: u,
                                        isCollapsed: t.has(a),
                                        onClick: () => M(a, l),
                                        trailing: g,
                        ...
                        (e, n) => {
                            ...
                            return (0, s.jsx)(
                                "div",
                                {
                                    ...
                                    className: o()(nL.Wy, {
                                        [nL.YD]: e === d.length - 1,
                                        [nL.jl]: t.has(l.sectionId),
                                        [nL.cW]: l.isNitroLocked,
                                        [nL.T5]: i || r,
                                    }),
                                    children: n,
                                },
        ...
        let ec = r.useCallback(
                (e) => {
                    (er(e),
                        nH({ emojiListRef: a, sectionDescriptors: f, scrollTop: e, searchQuery: M, setShowUpsell: Z }));
                },
                [er, a, f, M, Z],
            ),
            eh = f.length > 0;
    ...
    nH = eR().throttle(
        function (e) {
            ...
            s(
                (0, t5.s)({ listRef: t, searchQuery: i, nitroLockedSectionStates: n, scrollTop: l })
    ...
    n4 = r.memo(
        r.forwardRef(function (e, t) {
            ...
            let { location: eL } = (0, A.p)(),
                ...
                eG = r.useMemo(() => ({ ...eL, section: ew ?? Q.JJy.EMOJI_PICKER_POPOUT }), [eL, ew]),
                ...
                eZ = (0, G.oV)({ gridWrapperRef: eI, containerWidth: b, listPaddingLeft: n2, listScrollbarWidth: 8 }),
                {
            ...
            (((e, t) => {
                ...
                r.useLayoutEffect(() => {
                    ...
                    e7[t]?.[e] == null && 0 !== e && P.Om.setInspectedExpressionPosition(0, 0);
                }, [e7]),
                r.useEffect(() => {
                    if (("" === eA.current && "" !== eE && (0, ed.EG)(eG, i), "" !== eE && eA.current !== eE)) {
                        let e = P.Om.getAnalyticsId();
                        0 === eB
                            ? n6({ location: eG, searchQuery: eE, intention: i, loadId: e })
                            : n7({
                                  totalResults: eB,
            ...
            let td = (0, s.jsx)(x.A, {
                ...
                children: (0, s.jsxs)(ta, {
                    ...
                    className: o()(tq.iE, { [tq.r6]: N, [tq.cB]: eM }),
                    children: [
                        N ? null : tu,
                        (0, s.jsxs)("div", {
                            className: o()(tq.Fb, O),
