...
let td = {},
    ...
    tm = { [e1.dx]: nv("No Video Devices", e1.oh.VIDEO_INPUT) },
    tg = new v.Ep(),
    tS = !1,
    tN = !1,
    tC = !1,
...
function nS(e) {
    ...
    if ((0, f.isDesktop)()) {
        let { consecutiveFailures: t } = (function (e) {
            let { location: t } = e;
            return eo.getConfig({ location: t });
        })({ location: "updateConnectionVoiceProcessing" });
...
function nC() {
    return (0, f.isMac)() && tl.supports(e1.O5.SCREEN_CAPTURE_KIT) && R().satisfies(M.A?.os.release, ea.e);
}
function nO() {
    return (
        (0, f.isWindows)() &&
...
class nJ extends L.Ay.Store {
    ...
    initialize() {
        ...
        ((0, f.isWindows)() &&
            ...
            this.waitFor(eW.default, eY.A, eK.A, e$.A, G.Ay, B.A, ez.A, H.Ay, eG.A, eX.default, eq.A));
    }
    supports(e) {
    ...
    supportsExperimentalSoundshare() {
        return tl.supports(e1.O5.EXPERIMENTAL_SOUNDSHARE) && R().satisfies(M.A?.os.release, ea.$x);
    }
    supportsHookSoundshare() {
        return (0, f.isWindows)() && tl.supports(e1.O5.SOUNDSHARE) && R().satisfies(M.A?.os.release, ea.ws);
    }
    ...
    supportsScreenSoundshare() {
        return (0, f.isMac)()
            ? tl.supports(e1.O5.SOUNDSHARE) && R().satisfies(M.A?.os.release, ea.P$) && nC()
            : (0, f.isWindows)()
...
let n1 = (i = new nJ(b.h, {
    ...
    CONNECTION_OPEN: function (e) {
        ...
        (nO() && (nR() ? nq(e1.rB.AUTOMATIC) : t.automaticAudioSubsystem && nZ()),
            ...
            (0, f.isIOS)() && (tl.setNcModels?.(ed), i.emitChange()),
            nG(t.inputDeviceId),
            nF());
    },
