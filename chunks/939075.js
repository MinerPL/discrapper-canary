...
function N(t) {
    let { user: n, activity: e, entry: d, onAction: x, onClose: p, appContext: N } = t,
        g = (0, _.A)();
        ...
        return null != e
            ...
            : null != n
              ? (function (t) {
                    ...
                    return (0, u.A)(n) || (0, c.A)(n) || (0, r.A)(n) ? T : (0, o.A)(n) && !(0, s.A)(n) ? e : null;
                })({ activity: n, onOpenGameSettings: i })
              : null;
    })({ activity: e, entry: d, onOpenGameSettings: g });
    return null == C
        ? null
        : (0, i.jsx)(a.Dr, {
              id: "manage-privacy",
