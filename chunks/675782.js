...
let tl = s.memo(function (e) {
    ...
    async function d() {
        a(!0);
        try {
            r ? (0, n6.u)(n.guildId) : await n0.A.joinGuild(n.guildId, { source: er.Q4z.DIRECTORY_ENTRY });
        } finally {
            a(!1);
        }
    }
...
function t4(e) {
    ...
    return (0, l.jsx)(tT.Y, {
        ...
        onRequestClose: () => a(!1),
        renderPopout: (e) =>
            (0, l.jsx)(t6.A, { ...e, channel: n, navId: "thread-context", label: z.intl.string(z.t["1NBjqb"]) }),
        children: (e, n) => {
            let { isShown: i } = n;
...
function sM(e) {
    ...
    return (0, l.jsxs)(ns.Ay, {
        ...
        children: [
            (0, l.jsx)(ns.Ay.Icon, { icon: l6.y, disabled: !0, "aria-label": z.intl.string(z.t["7Xm5QI"]) }),
...
function rC(e) {
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsxs)(rm.A, {
            ...
            onClick: j,
            "aria-label":
                ((n = y ? (0, rA.T)(t) : z.intl.formatToPlainString(z.t.ZBB4Ty, { productName: (0, rA.T)(t) })),
        ...
        : (0, l.jsx)("section", {
              ...
              children: (0, l.jsxs)(am.A.Overlay, {
                  ...
                  children: [
                      ...
                      (0, l.jsx)(s1.F, { children: (0, l.jsx)("div", { className: rP.vY, children: E }) }),
                  ],
              }),
          });
}
...
function rU(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsx)(a7.A, { user: n }),
            i?.private &&
                (0, l.jsx)(am.A.Overlay, { children: (0, l.jsx)(a6.A, { username: s6.Ay.getName(null, a.id, n) }) }),
            n.isProvisional &&
                (0, l.jsx)(am.A.Overlay, {
                    className: aT.Lw,
                  ...
                  u &&
                      (0, l.jsx)(rK, {
                          ...
                          items: o.map((e) => {
                              ...
                              return (0, l.jsx)(
                                  rV.A,
                                  { user: n, guild: t, nick: i, onSelect: () => (0, n6.u)(t.id) },
                                  t.id,
                              );
                          }),
                      }),
...
function rZ(e) {
    let { channel: n } = e,
        ...
        m = (0, lM.Ay)(t),
        g = (0, s3.c)("UserProfileSidebarRenderer") ? m?.profileFrame?.skuId : void 0,
...
let dg = (0, nU.Fe)({ createPromise: dm, webpackId: 540462, name: "ChannelCall", renderLoader: du });
function dx() {
    return Promise.all([
        t.e("770583"),
        t.e("947359"),
...
class dj extends s.PureComponent {
    ...
    maybePreloadChannelCall() {
        ...
        e === er.rbe.GUILD_VOICE ? dm() : e === er.rbe.GUILD_STAGE_VOICE && dx();
    }
                    ...
                    children: (a) =>
                        (0, l.jsxs)(
                            i9.A,
                            {
                                ...
                                className: r()(dc.DD, a, { [dc.zh]: e.type === er.rbe.GROUP_DM }),
                                transparent: x,
                                hidden: c,
    ...
    renderCall() {
        ...
        switch (e.type) {
            case er.rbe.GUILD_STAGE_VOICE:
                return (0, l.jsx)(dp, { channel: e, popoutType: nu.N.NO_POPOUT }, e.id);
            case er.rbe.GUILD_VOICE:
            case er.rbe.DM:
            case er.rbe.GROUP_DM:
            case er.rbe.PUBLIC_THREAD:
    ...
    renderSidebar() {
        ...
        else if (s === er.YvQ.SEARCH) return (0, l.jsx)(df, { guildId: t?.id, channelId: e.id });
        return null;
    }
    openChannelModal() {
        let {
    ...
    renderThreadSidebar() {
        ...
        return (
            ...
            (0, l.jsx)(r9.A, {
                sidebarType:
                    n?.type != null && er.kvI.GUILD_THREADS_ONLY.has(n.type) ? r9.X.PostSidebar : r9.X.ThreadSidebar,
                maxWidth: c,
    ...
    render() {
                ...
                children: [
                    (0, l.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, l.jsxs)("div", {
                                className: r()(dc.Qs, { [dc.Oo]: s === er.DUB.NO_CHAT }),
        ...
        return (0, l.jsxs)(l.Fragment, {
            children: [
                ...
                u ? (0, l.jsx)("div", { className: dc.zP, children: j }) : j,
                m && (0, l.jsx)(db, {}),
            ],
        });
    }
...
let dC = (0, ep.A)(dj),
    dE = s.memo(function (e) {
        ...
        let i,
            ...
            S = (0, A.bG)([r3.A], () => r3.A.isConnected()),
            R = (0, eI.Ay)(S),
            L = S && !1 === R;
        s.useEffect(() => {
            _ &&
        ...
        let O = (0, A.bG)([eb.Ay], () => eb.Ay.getCurrentEmbeddedActivity()),
            ...
            V = (0, A.bG)([r1.A], () => r1.A.hasSeen(f?.guild_id, B), [f, B]),
            W = (0, A.bG)(
                [nc.A, eb.Ay],
                () =>
            ...
            Y =
                ...
                (0, A.bG)([ek.A, n7.A, eU.Ay], () => {
                    ...
                    return H === eU.Ay.getChannelId(t) && null != n && n.getGuildId() === e.id && (0, r2.ke)(n.type);
                })),
