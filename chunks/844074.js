...
var h = "hcaptcha-api-script-id",
    c = "hcaptchaOnLoad",
    p = [],
    d = function (t) {
        void 0 === t && (t = {});
        var e = r(t.scriptLocation);
        delete t.scriptLocation;
        var a = o(e),
            i = p.find(function (t) {
                return t.scope === a.window;
            });
        if (a.document.getElementById(h) && i) return i.promise;
...
let l = (function (t) {
    ...
    return (
        (a.componentDidMount = function () {
            var t = this,
                e = o(r(this.props.scriptLocation));
