...
let I = {
    ...
    A = {};
class y extends C.Ay.DeviceSettingsStore {
...
function N() {
    ...
    if (
        ...
        (delete m[e], null != v[n] && v[n].delete(e));
        return;
    }
    return (m[e]++, null == v[n] && (v[n] = new Set()), _.Ay.isFavorite(n, e))
        ? void v[n].delete(e)
        : (null == w[n] || !w[n].has(e)) && m[e] > 50
          ? (v[n].add(e), !0)
          : void 0;
}
class R extends C.Ay.PersistedStore {
    ...
    initialize(e) {
        if ((this.waitFor(S.A, E.Ay, _.Ay), this.syncWith([E.Ay], N), null == e)) return;
        let { suggestedChannels: t, dismissedSuggestions: n, channelOpensByChannelId: i } = e;
        if (null != t) for (let e in t) v[e] = new Set(t[e]) ?? new Set();
        if (null != n) for (let e in n) w[e] = new Set(n[e]) ?? new Set();
        m = i ?? {};
    }
...
class O extends C.Ay.PersistedStore {
    ...
    initialize(e) {
        (G.clear(), e?.guilds.forEach((e) => G.add(e)));
    }
    isCollapsed(e) {
        return G.has(e);
    }
...
class eo {
    ...
    constructor(e, t, n) {
        ...
        ((this.moderatorReportChannelId = null != l ? (0, D.A)(l) : null),
            (this.moderatorReportChannelEnabled = null != l && (0, U.A)(l)));
        const a = {},
            d = [],
            o = {};
        for (const e in i) {
        ...
        ((this.recentsSectionNumber = es),
            ...
            (this.guildActionSection = new eA(t, g.length > 0)),
    ...
    get initializationData() {
        return {
            selectedChannel: S.A.getChannel(E.Ay.getChannelId()),
            selectedVoiceChannelId: E.Ay.getVoiceChannelId(),
...
class ey {
    ...
    get lastMessageTimestamp() {
        return Math.max(Y.Ay.lastMessageTimestamp(this.id), ...this.threadIds.map(Y.Ay.lastMessageTimestamp));
    }
    updateChannel(e, t) {
        let n = !1;
...
class ef extends ey {
    computeState(e) {
        ...
        if (em(a, this.record)) return { renderLevel: 1, threadIds: [] };
        let d = t?.id === this.id || n === this.id,
            ...
            c = ew(this.record, u, t, n, a.hideMutedChannels);
        return this.id !== a.moderatorReportChannelId || a.moderatorReportChannelEnabled
            ? a.optInEnabled && a.hideResourceChannels && this.record.hasFlag(Z.lx.IS_GUILD_RESOURCE_CHANNEL)
                ...
                : !a.optInEnabled || a.optedInChannels.has(this.id) || (null != l && a.optedInChannels.has(l))
                  ? d || o || !r().isEmpty(c) || Y.Ay.getMentionCount(this.id) > 0
                      ...
                      : a.hideMutedChannels && a.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed &&
                            (a.mutedChannelIds.has(this.id) ||
                                ...
                                ((0, F.ig)(this.record.type) && !Y.Ay.hasUnread(this.record.id)))
...
class eS extends ey {
    computeState(e) {
        ...
        return H.A.can($.xB.VIEW_CHANNEL, this.record)
            ? { renderLevel: 4, threadIds: ew(this.record, i[this.id] ?? {}, t, n, !1) }
...
class e_ extends ef {
    getRenderLevel(e) {
        ...
        return !H.A.can($.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || em(t, this.record)
            ? 1
            : this.category.isCollapsed
...
function ev(e, t, n) {
    switch (e.type) {
        case X.rbe.GUILD_VOICE: {
            ...
            let s = W.Ay.getVoiceStatesForChannel(e);
    ...
    if (F.wE.has(e.type)) {
        ...
        return l
            ...
            : a
              ...
              : s
                ? e.filter((e) => !M.A.isMuted(e) || Y.Ay.getMentionCount(e) > 0)
                : e;
    }
    return [];
}
...
function eN(e, t) {
    ...
    if (Y.Ay.getMentionCount(e.id) > 0) return !0;
    for (let t in i[e.id]) if (Y.Ay.getMentionCount(t) > 0) return !0;
...
function eR(e, t, n) {
    ...
    if (
        ...
        return !1;
    if ((null != i && (i.id === t.id || (i.isThread() && i.parent_id === t.id))) || Y.Ay.getMentionCount(t.id) > 0)
        return !0;
    for (let e in s[t.id])
        if (Y.Ay.getMentionCount(e) > 0 || Y.Ay.hasUnread(e) || Y.Ay.hasRecentlyVisitedAndRead(e)) return !0;
