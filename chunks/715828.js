...
let r = class {
    ...
    compute(e, t) {
        let n = this.paddingTop,
            ...
            l = [];
        function o(a) {
            return ((r = n), (n += a) < e) ? ((i += a), !1) : !(r > t);
        }
        o(this.getListHeaderHeight()) && l.push({ type: "header", section: -1, offsetTop: r });
                ...
                if (
                    ...
                    for (let n = 0; n < t; n++)
                        (o(this.getHeightForRow(e, n)) &&
                            ...
                            (a += 1),
                            (s += 1));
                o(this.getHeightForFooter(e)) && l.push({ type: "footer", section: e, offsetTop: r });
            }
        }
