...
let L = "/omni/add/front-id";
async function I(l) {
    let { file: t, signal: d, onProgress: i, extractIdFace: c } = l,
        a = { idType: "DigitalId" };
    !1 === c && (a.extractIdFace = !1);
    let s = await e.t.post(L, t, {
        query: a,
        headers: { "Content-Type": t.type || "application/pdf" },
        onUploadProgress: i,
        signal: d,
    });
    if (!s.ok) throw Error(`POST ${L} failed: ${s.status}`);
    return { ...s.data, uploadDurationMs: 0 };
}
let z = ["application/pdf"],
    w = (0, b.a)(async ({ input: l, signal: t }) =>
        I({ file: l.file, signal: l.signal ?? t, onProgress: l.onProgress, extractIdFace: l.extractIdFace }),
    ),
    R = (l) => {
    ...
    S = (0, b.t)({
        ...
        actions: {
            ...
            setFailReasonFromResponse: (0, b.r)(({ event: l }) =>
                "output" in l ? { failReason: V(l.output) ?? "GENERIC" } : {},
            ),
        ...
        guards: {
            ...
            isSelectedFileMimeInvalid: ({ event: l }) => "FILE_PICKED" === l.type && !z.includes(l.file.type),
            hasSelectedFile: ({ context: l }) => null !== l.file,
            responseHasFailReason: ({ event: l }) => null !== V(R(l)),
    ...
    C = new Set(["DIGITAL_ID_REQUESTED_BUT_OTHER_PROVIDED", "ID_TYPE_UNACCEPTABLE"]);
function x(l, t) {
    let d = l.failReason;
...
async function E(l) {
    ...
    if (
        ...
        d.settings && e.setSettings({ ...k, ...d.settings }),
        i)
    )
        try {
    ...
    let { stream: c, fallbackLevel: a } = await U(),
...
function K(l, t) {
    ...
    if (!l.classification) return { error: !0, message: "ID classification failed", errorKey: F.CLASSIFICATION_FAILED };
    let d = "desktop" === (0, M.t)() ? -1 : 10;
...
async function Q(l) {
    ...
    try {
        ...
        let a = l.data,
            n = await H({ type: t, ageAssurance: s, signal: c }),
            Z = {
                ...a,
                originalImage: d,
...
async function f(l) {
    ...
    let t = l.config.recording?.capability ?? (await P()),
        d = l.stream.clone(),
        ...
        c = await (0, W.h)(l.type),
        a = await t.connect({ sessionToken: c.token, stream: d, events: {} });
    return (
        await (0, W.g)({ videoRecordingId: c.videoRecordingId, type: l.type, resolution: e, hasAudio: i }),
        {
            token: c.token,
...
let _ = async (l) => {
        var t;
        let d;
        return -1 === (d = (t = await j(l)).indexOf(",")) ? t : t.slice(d + 1);
    },
    $ = (0, b.a)(async ({ input: l, signal: t }) => {
        let d,
            i,
            e = await _(l.file);
    ...
    lt = (0, b.t)({
        ...
        actions: {
            ...
            setManualUploadErrorFromResponse: (0, b.r)(({ context: l, event: t }) => {
                let d = ll(t);
                return d ? { errorMessage: x(d, l.activeTab) ?? "manualIdUpload.generic" } : {};
            }),
        ...
        guards: {
            ...
            manualUploadResponseHasError: ({ context: l, event: t }) => {
                let d = ll(t);
                return !!d && null !== x(d, l.activeTab);
            },
            manualUploadPayloadTooLarge: ({ event: l }) => q(l)?.type === "fileTooLarge",
        },
    }).createMachine({
        id: "manualUpload",
        initial: "selecting",
    ...
    la = (0, b.i)(({ input: l, sendBack: t }) => {
        ...
        let d = l.provider,
            ...
            M = (0, N.n)(p?.width() ?? 1280, p?.height() ?? 720);
        l.config.geometry
            ? d.setGeometry({
                  ...l.config.geometry,
    ...
    ls = (0, b.a)(async ({ input: l, signal: t }) => {
        let d,
            i = l.canvas.getBase64Image();
        if (!i) throw Error(F.UPLOAD_ERROR);
    ...
    ln = (0, b.a)(async ({ input: l, signal: t }) => B(l.isSecondId, "", t)),
    lZ = (0, b.a)(async ({ input: l }) => {
        if (!l.stream) return;
        let t = "back" === l.currentMode ? "backId" : "frontId";
        return f({ config: l.config, stream: l.stream, existing: l.existing, type: t });
    }),
...
let lh = "ID capture module has no accepted documents and no capture option enabled",
    lW = (0, b.t)({
        types: { context: {}, events: {}, input: {} },
        actors: {
            checkPermission: li,
            requestPermission: le,
            initializeCamera: lc,
            runDetection: la,
            uploadIdImage: ls,
            processId: ln,
            startRecording: lZ,
            initializeDeepsightSession: lb,
            checkVirtualCamera: lm,
            manualUploadMachine: lt,
            digitalUploadMachine: S,
        },
        actions: {
            stopMediaStream: (0, b.r)(({ context: l }) => (lo(l), { stream: void 0, frameCapturer: void 0 })),
            ...
            setStreamAndCapturer: (0, b.r)({
                ...
                frameCapturer: ({ event: l }) =>
                    (function (l) {
                        if ("output" in l) {
                            let t = l.output;
                            if (t.stream) return new X.t(t.stream);
                        }
                    })(l),
            ...
            preloadRecordingProvider: ({ context: l }) => {
                !0 === l.config.enableIdRecording && (0, y.n)();
            },
            ...
            storeCapturedCanvasInProvider: ({ context: l, event: t }) => {
                !(function (l, t) {
                    ...
                    if (!e || !c) return;
                    let a = i,
                        { innerWidth: s, innerHeight: n } = (0, N.n)();
                    if (l.detectionArea) {
            ...
            stopMediaRecording: ({ context: l }) => {
                ...
                l.recordingSession &&
                    ...
                    (async () => {
                        try {
                            await (0, W._)(t.videoRecordingId);
                        } finally {
        ...
        guards: {
            ...
            isReadyForCapture: ({ context: l, event: t }) =>
                (0, r.t)((0, r.r)("output" in t ? t.output : void 0, l.permissionResult), l.config.ds),
            needsMotionPrimeOnly: ({ context: l, event: t }) =>
                (0, r.n)((0, r.r)("output" in t ? t.output : void 0, l.permissionResult), l.config.ds),
        ...
        context: ({ input: l }) => {
            ...
            return {
                ...
                availableDocumentTypes: (function (l) {
                    let t = [];
                    for (let [d, i] of ld) l[d] && t.push(i);
                    return t;
                })(l.config),
                captureResolution: void 0,
                cameraFallbackLevel: void 0,
                    ...
                    LOAD: [
                        {
                            ...
                            actions: [() => console.error(lh), (0, b.r)({ error: () => lh })],
                        },
                    ...
                    uploading: {
                        ...
                        invoke: {
                            ...
                            input: ({ context: l, self: t }) => {
                                ...
                                if (!d) throw Error(F.UPLOAD_ERROR);
                                return {
                                    canvas: d,
                                    ...
                                    uploadError:
                                        (function (l) {
                                            if (l instanceof Error) {
                                                let t = l.message;
                                                return Object.values(F).find((l) => t.includes(l));
                                            }
...
function lp({ actor: l, trackElementClicked: t, trackCaptureAttemptFinished: d }) {
    let i = l.getSnapshot();
    return (
        i.context.dependencies && (i.context.dependencies.trackCaptureAttemptFinished = d),
        {
            ...
            async nextStep() {
                ...
                if (d.matches("tutorial")) {
                    ...
                    await (0, u.r)({ ds: l.ds, cameraGranted: "granted" === t });
                }
...
let lN = {
    ...
    lX = { tutorial: "idCapture.tutorial.passport" };
function lr(l, t) {
    switch (t) {
        case "wrongSide":
...
function lT(l) {
    return (function (l) {
        ...
        let i = (0, c.o)(t);
        if (void 0 === i) return;
        let e = "back" === (a = d.currentMode) ? lM : "passport" === a ? { ...lN, ...lX } : lN;
        switch (i) {
            case "idle":
            case "loading":
                    ...
                    if (void 0 !== e) {
                        ...
                        if ("object" == typeof e && null !== e) {
                            ...
                            if (
                                ...
                                return "idCapture.loader.preparingcamera";
                            if (d.includes("detecting")) return lr(t, i.detectionStatus);
                            ...
                            if (d.includes("uploading") || d.includes("validatingUpload"))
                                return `${t.analyzingPrefix}.uploading`;
                            if (d.includes("uploadError")) return ly(t, i.uploadError);
...
function lI(l) {
    ...
    if (void 0 !== d) return { errorCode: d, reason: lV[d] ?? "failed" };
}
function lz(l) {
    let t;
    return (function (l, t = new o.t()) {
        return (0, b.l)({
            actor: l,
            mapState: lG,
            createApi: lp,
            instrumentation: (0, c.s)(c.n.idCapture, {
                getEventScreenName: lT,
                getErrorName: lL,
                getErrorPayload: lI,
        ...
        ((t = l.dependencies ?? { storage: new h.t() }),
        (0, b.s)(lW, { input: { config: l.config, dependencies: t } }).start()),
    );
}
async function lw(l, t) {
    let d = l.canvas;
    if (!d) throw Error(F.UPLOAD_ERROR);
