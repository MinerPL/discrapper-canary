...
t.detectFile = function (e, t) {
    ...
    let a = [],
        s = [];
    for (let e in i.FileTypes)
        if (Object.prototype.hasOwnProperty.call(i.FileTypes, e)) {
            let t = i.FileTypes.getSignaturesByName(e),
                n = i.FileTypes.detectbBySignatures(o, t);
            if (n) {
                let t = i.FileTypes.getInfoByName(e);
                i.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(t.extension) && s.push(t.extension);
                let r = {
    ...
    let l = i.FileTypes.detectTypeByAdditionalCheck(o, a);
