...
var r = n(477900),
    ...
    j = n(105499);
function G(e) {
    return (0, r.jsx)("div", { className: j.hm, children: (0, r.jsx)(D, { ...e }) });
}
function M(e) {
    return (0, r.jsx)(f.A, { gap: "xl", "aria-label": N.intl.string(N.t.HP8LNG), children: (0, r.jsx)(D, { ...e }) });
}
function D(e) {
...
let U = function (e) {
    ...
    switch (i) {
        case "feed":
            return (0, r.jsx)(G, { heroBlockRecord: a, isLoading: _, products: c, tab: o });
        case "hscroll":
            return (0, r.jsx)(M, { heroBlockRecord: a, isLoading: _, products: c, tab: o });
    }
};
var F = n(758836),
    w = n(652215);
let V = {
    ...
    K = (e) => {
        let {
            ...
            D = (0, I.uM)(),
            { analyticsLocations: K } = (0, L.Ay)(S.A.COLLECTIBLES_SHOP_HERO),
            W = s.useMemo(
                () =>
                    null != f
                        ? f
        ...
        function es() {
            et
                ? ((0, A.Y)({
                  ...
                  (0, p.mA)({ fromContent: o.u.ORBS_SHOP_HERO_CTA }))
                : (n?.({
        ...
        if (null == M || (!t && W === V)) return null;
        function el() {
            return t || b ? null : (0, r.jsx)(g.$, { variant: "overlay-primary", onClick: es, text: er });
        }
        return (0, r.jsx)(L.f5, {
            value: K,
            children: (0, r.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, r.jsx)("div", {
                        className: a()(j.vK, { [j.cN]: ee, [j.no]: Q }),
