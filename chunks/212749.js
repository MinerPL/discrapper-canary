...
((t.isAVI = function (e) {
    ...
    (t.isFLV = function (e) {
        let t = (0, r.getFileChunk)(e);
        return !!i.FileTypes.checkByFileType(t, "flv") && (0, r.isFlvStringIncluded)(t);
    }),
    (t.isM4V = o),
    (t.isMKV = function (e) {
        let t = (0, r.getFileChunk)(e, 64);
        return !!i.FileTypes.checkByFileType(t, "mkv") && "mkv" === (0, r.findMatroskaDocTypeElements)(t);
    }),
    (t.isMOV = function (e) {
        let t = (0, r.getFileChunk)(e);
        return i.FileTypes.checkByFileType(t, "mov");
    }),
    (t.isMP4 = function (e, t) {
        let n = (0, r.getFileChunk)(e);
        return !!i.FileTypes.checkByFileType(n, "mp4") || ((null == t || !t.excludeSimilarTypes) && o(n));
    }),
    (t.isOGG = function (e) {
        let t = (0, r.getFileChunk)(e);
        return i.FileTypes.checkByFileType(t, "ogg");
    }),
    (t.isSWF = function (e) {
        let t = (0, r.getFileChunk)(e);
        return i.FileTypes.checkByFileType(t, "swf");
    }),
    (t.isWEBM = function (e) {
        let t = (0, r.getFileChunk)(e, 64);
