...
function G(i) {
    ...
    return r
        ? (0, e.jsx)("ul", {
              className: P.Ui,
              "aria-label": k.intl.string(k.t.qe4kTa),
              children: c.map((i) =>
                  (0, e.jsx)(
                      "li",
                      {
...
function $(i) {
    ...
    return (0, e.jsxs)("div", {
        className: F.k,
        children: [
            null != s ? (0, e.jsx)(H.A, { groupListingId: s.id, subscription: r }) : null,
                ...
                children: l.map((i) =>
                    (0, e.jsx)(
                        W.A,
                        {
                            ...
                            groupListingId: s?.id ?? "",
                            listingId: i,
                            analyticsLocation: q.ThZ.ROLE_SUBSCRIPTIONS_TAB,
                        },
                        i,
                    ),
                ),
...
function X(i) {
    let { guildId: t } = i;
    return (0, e.jsx)(B.H, { guildId: t, children: (0, e.jsx)($, { guildId: t }) });
}
var Q = s(702841),
    Y = s(506774),
    J = s(890856),
...
function ig(i) {
    ...
    return (0, e.jsxs)(J.s, {
        ...
        children: [
            ...
            (0, e.jsx)(c.h, { size: 8, horizontal: !0 }),
            (0, e.jsxs)("div", {
                children: [
                    (0, e.jsx)(K.E, {
                        variant: "text-sm/semibold",
                        color: r ? "text-overlay-light" : "text-strong",
                        children: s,
                    }),
                    (0, e.jsx)(K.E, {
                        variant: "text-xs/normal",
                        color: r ? "text-overlay-light" : d ? "text-muted" : "text-strong",
                        children: l,
                    }),
                ],
            }),
...
function ip(i) {
            ...
            switch (i) {
                ...
                case N.B.GUILD_ROLE_SUBSCRIPTIONS:
                    return (0, e.jsx)(
                        ig,
                        {
                            icon: (0, e.jsx)(ic, { width: 20, height: 20 }),
                            title: k.intl.string(k.t["KzCF/6"]),
                            body: s
    ...
    return (0, e.jsxs)("div", {
        className: ij.kL,
        children: [
            (0, e.jsx)(il.D, { variant: "heading-sm/bold", className: ij.wx, children: k.intl.string(k.t.GF433I) }),
            (0, e.jsx)(c.h, { size: 12 }),
            (0, e.jsxs)("div", {
                className: ij.uW,
                children: [
...
function iR() {
    let i = i_.kt.useSetting(),
        t = (0, iv.j)(),
        s = (0, Q.bG)([ir.Ay], () => ir.Ay.useReducedMotion),
        l =
            t && i && !s
                ? (0, id.n)("server_products/storefront/question-mark.gif")
                : (0, id.n)("server_products/storefront/question-mark.png");
    return (0, e.jsxs)("div", {
        ...
        children: [
            (0, e.jsx)(iL.A, {
                role: void 0,
                ctaComponent: null,
                imageUrl: (0, id.n)("server_products/storefront/preview-thumbnail.png"),
                name: k.intl.string(k.t.U2hvDo),
                description: k.intl.string(k.t["w/TNGT"]),
                formattedPrice: (0, iI.$g)(0, q.Yri.USD, {
                    localeMatcher: "best fit",
                    style: "currency",
                    maximumSignificantDigits: 1,
                }),
                shouldShowFullDescriptionButton: !1,
                productType: k.intl.string(k.t.ih4QMU),
                onTapCard: () => null,
                hideRoleTag: !0,
                lineClamp: 3,
                thumbnailHeight: 197,
            ...
            (0, e.jsx)("img", { className: iT.kz, alt: "", src: l }),
        ],
    });
}
function iS() {
    return (0, e.jsxs)("div", {
        ...
        children: [
            ...
            (0, e.jsx)(K.E, {
                ...
                color: "text-muted",
                children: k.intl.format(k.t.umfZ8q, { learnMoreLink: ix.rv }),
            }),
        ],
    });
}
    ...
    return null == n || (!o && x)
        ...
        : (0, e.jsx)(R.default, {
              ...
              children: (0, e.jsxs)("div", {
                  className: iP.hQ,
                  children: [
                      (0, e.jsx)(iD.A, { guild: n, subscriptionsSettings: r }),
                      (0, e.jsx)(c.h, { size: 32 }),
                      u.length > 0 && (0, e.jsx)(ip, { guild: n }),
                      (0, e.jsxs)("div", {
                          className: iP.v_,
                          children: [
                              (0, e.jsx)(c.h, { size: 32 }),
