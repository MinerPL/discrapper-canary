    ...
    s = (e, t, i, r) => {
        ...
        return (s) => {
            ...
            t.value >= 0 &&
                ...
                (t.delta = a),
                (o = t.value),
                (t.rating = o > i[1] ? "poor" : o > i[0] ? "needs-improvement" : "good"),
                e(t));
        };
    },
    o = (e) => {
...
let m = (e, t, i = {}) => {
            ...
            ((v =
                (document.prerendering
                    ...
                    : globalThis.performance
                          ...
                          .filter((t) => "hidden" === t.name && t.startTime > e)[0]?.startTime) ?? T()),
                    ...
                    for (let t of e)
                        "first-contentful-paint" === t.name &&
                            ...
                            t.startTime < i.firstHiddenTime &&
                                ((n.value = Math.max(t.startTime - d(), 0)), n.entries.push(t), r(!0)));
                });
            l &&
    ...
    I = (e) => {
        for (let t of e)
            t.interactionId &&
                ((k = Math.min(k, t.interactionId)), (S = (A = Math.max(A, t.interactionId)) ? (A - k) / 7 + 1 : 0));
    },
            ...
            if (
                (i
                    ? e.duration > i.P
                        ...
                        : e.duration === i.P && e.startTime === i.entries[0].startTime && i.entries.push(e)
                    : ((i = { id: e.interactionId, entries: [e], P: e.duration }), this.l.set(i.id, i), this.u.push(i)),
    ...
    R = (e, t = {}) => {
        ...
        C(() => {
            "interactionCount" in performance ||
                r ||
                (r = m("event", I, { type: "event", buffered: !0, durationThreshold: 0 }));
            let n,
                o = h("INP"),
                l = p(t, H),
                d = (e) => {
                    x(() => {
                        for (let t of e) l.h(t);
                        let t = l.L();
                        t && t.P !== o.value && ((o.value = t.P), (o.entries = t.entries), n());
                    });
                },
