...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "609821", versionHash: "7eb60d34acddcbed16a622fe5a779db75a82d3ff" }, void 0, 2)}
