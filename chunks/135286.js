...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "608846", versionHash: "2a00b14554dc83614959cf4f6cec8da935286fdf" }, void 0, 2)}
