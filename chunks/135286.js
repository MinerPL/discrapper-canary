...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "608705", versionHash: "88aa956ca2f070c52114bf317d06acd13a9abbc3" }, void 0, 2)}
