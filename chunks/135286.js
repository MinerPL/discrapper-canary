...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "610692", versionHash: "80003e5f911f922dc11524a673aec869917a39e9" }, void 0, 2)}
