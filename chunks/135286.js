...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "612025", versionHash: "7d9f4d633607f80f44f491cf8446d821e8db802a" }, void 0, 2)}
