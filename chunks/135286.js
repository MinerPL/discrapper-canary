...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "609619", versionHash: "653ade245d0aa88c29605e7dc58464aa5f9ebb00" }, void 0, 2)}
