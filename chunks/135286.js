...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "610673", versionHash: "8242e47a8c66ef4b7f12df5a8c035dfaca92eb4f" }, void 0, 2)}
