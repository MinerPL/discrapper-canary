...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "611372", versionHash: "c9b5272e8751655d7d96db1de0bd345f8de455cf" }, void 0, 2)}
