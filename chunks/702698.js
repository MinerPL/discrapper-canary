...
function m(t) {
    ...
    return (0, i.jsx)(l.Modal, {
        ...
        subtitle: (0, d.m1)(n.planId)
            ? g.intl.format(g.t.GMp54C, { downgradedPlan: u.Ay.getDisplayName(a.planId), existingRate: v })
        ...
        actions: [
            { text: g.intl.string(g.t.oEAioF), onClick: m, variant: "secondary" },
            { text: g.intl.string(g.t.frE8KO), onClick: x, variant: "primary" },
        ],
        onClose: m,
        transitionState: e,
    });
