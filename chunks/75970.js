...
function h(l, t) {
    return { ...l?.configuration, ds: t?.ds };
}
function W(l, t) {
...
(0, e.t)({
    ...
    actions: {
        ...
        incrementStep: (0, e.r)(({ context: l }) => {
            ...
            return { currentStepIndex: t, currentStep: d?.key, config: h(d, l.flow) };
        }),
...
let p = new WeakSet(),
    N = { HOME_CONTINUE: { actions: "setHomeContinueLoading" } },
    M = (0, e.t)({
        types: { context: {}, events: {}, input: {} },
        actors: {
        ...
        actions: {
            resetContext: (0, e.r)(({ context: l }) => G(l, !1)),
            resetContextForLoad: (0, e.r)(({ context: l }) => G(l, l.isHomeContinueLoading)),
        ...
        states: {
            idle: { on: { LOAD: { target: "loading", actions: "resetContextForLoad" }, ...N } },
            loading: {
                invoke: {
                    id: "fetchFlow",
                    src: "fetchFlow",
                ...
                on: { CANCEL: { target: "idle", actions: "resetContext" }, ...N },
            },
            resolvingModule: {
                invoke: {
                ...
                on: { RESET: { target: "idle", actions: "resetContext" }, ...N },
            },
            home: {
                on: {
                    HOME_CONTINUE: {
