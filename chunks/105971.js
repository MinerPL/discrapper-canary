...
function o(e) {
    switch (e.data.kind) {
        ...
        case "loading":
            return "loading";
        case "message":
            if (e.channelType === l.rbe.GUILD_ANNOUNCEMENT) return "announcement";
            return "message";
        case "guildEvent":
            return "guild_event";
...
function d(e) {
    switch (e.type) {
        case s.Mm.MESSAGE:
            if (e.data.channel_type === l.rbe.GUILD_ANNOUNCEMENT) return "announcement";
            return "message";
        case s.Mm.ACTIVITY:
            return "hotwheels_gaming_activity";
        case s.Mm.CUSTOM_STATUS:
            return "hotwheels_custom_status";
        case s.Mm.GUILD_EVENT:
            return "guild_event";
        case s.Mm.RECOMMENDED_GUILDS:
            return "recommended_guilds";
    }
}
let c = {
    trackItemInteraction(e) {
        r.default.track(l.HAw.FEED_ITEM_INTERACTED, {
    ...
    trackItemShortImpression(e, t, n) {
        r.default.track(l.HAw.FEED_ITEM_SEEN_BATCH, {
            load_id: a.A.getLoadId(),
            home_session_id: "gravity",
    ...
    trackItemLongImpression(e, t, n) {
        r.default.track(l.HAw.FEED_ITEM_SEEN_LONG, {
            load_id: a.A.getLoadId(),
            home_session_id: "gravity",
            feed_item_ids: e.map((e) => e.item.id),
            feed_item_types: e.map((e) => o(e.item)),
    ...
    trackFeedFirstScrollStarted() {
        r.default.track(l.HAw.HOME_FIRST_SCROLL_STARTED, { load_id: a.A.getLoadId(), home_session_id: "gravity" });
    },
    trackFeedFeedbackPromptViewed() {
        r.default.track(l.HAw.HOME_FEEDBACK_PROMPT_VIEWED);
    },
    trackFeedFeedbackSubmitted(e) {
        r.default.track(l.HAw.HOME_FEEDBACK_SUBMITTED, { load_id: a.A.getLoadId(), home_session_id: "gravity", ...e });
    },
    trackFeedOnboardingScreenSkipped(e) {
        r.default.track(l.HAw.ICYMI_ONBOARDING_SCREEN_SKIPPED, { location: e.location });
    },
    trackFeedOnboardingGuildToggled(e) {
        r.default.track(l.HAw.ICYMI_ONBOARDING_GUILD_TOGGLED, { guild_id: e.guildId, toggled: e.toggled });
    },
    trackFeedOnboardingCategoryToggled(e) {
        r.default.track(l.HAw.ICYMI_ONBOARDING_CATEGORY_TOGGLED, { category_id: e.categoryId, toggled: e.toggled });
    },
    trackFeedEmptyLoadingSeen() {
        r.default.track(l.HAw.ICYMI_FEED_EMPTY_LOADING_SEEN, { load_id: a.A.getLoadId(), version: a.A.getVersion() });
    },
    trackFeedEmptyLoadingComplete(e) {
        r.default.track(l.HAw.ICYMI_FEED_EMPTY_LOADING_COMPLETE, {
            load_id: a.A.getLoadId(),
    ...
    trackFeedEmptyLoadingAbandoned(e) {
        r.default.track(l.HAw.ICYMI_FEED_EMPTY_LOADING_ABANDONED, {
            load_id: a.A.getLoadId(),
            dwell_time_ms: e.dwellTimeMs,
            version: a.A.getVersion(),
        });
    ...
    trackFeedSessionStarted(e) {
        r.default.track(l.HAw.FEED_SESSION_STARTED, {
            load_id: a.A.getLoadId(),
            version: a.A.getVersion(),
    ...
    trackFeedSessionCompleted(e) {
        r.default.track(l.HAw.FEED_SESSION_COMPLETED, {
            load_id: a.A.getLoadId(),
            version: a.A.getVersion(),
    ...
    trackFeedItemDwell1s(e) {
        r.default.track(l.HAw.FEED_ITEM_1S_DWELLED, {
            load_id: a.A.getLoadId(),
            version: a.A.getVersion(),
            impression_id: e.impressionId,
            item_id: e.itemId,
    ...
    trackFeedItemDwelled(e) {
        r.default.track(l.HAw.FEED_ITEM_DWELLED, {
            load_id: a.A.getLoadId(),
            version: a.A.getVersion(),
            impression_id: e.impressionId,
            dwell_time_ms: e.dwellTimeMs,
    ...
    trackFeedItemActioned(e) {
        r.default.track(l.HAw.FEED_ITEM_ACTIONED, {
            load_id: a.A.getLoadId(),
            icymi_session_id: e.icymiSessionId,
            ux_variation: e.uxVariation,
            version: a.A.getVersion(),
    ...
    trackFeedFilterActioned(e) {
        r.default.track(l.HAw.FEED_FILTER_ACTIONED, {
            load_id: a.A.getLoadId(),
            icymi_session_id: e.icymiSessionId,
            ux_variation: e.uxVariation,
            version: a.A.getVersion(),
    ...
    trackFeedPageActioned(e) {
        r.default.track(l.HAw.FEED_PAGE_ACTIONED, {
            load_id: a.A.getLoadId(),
            icymi_session_id: e.icymiSessionId,
            ux_variation: e.uxVariation,
            version: a.A.getVersion(),
