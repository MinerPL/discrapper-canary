...
var a = {
    ...
    "upi.qrCodeWaitingMessage":
        "Scannez le code QR \xe0 l'aide de votre application UPI pr\xe9f\xe9r\xe9e pour effectuer le paiement",
    ...
    "onlineBankingPL.termsAndConditions":
        "En continuant, vous acceptez les %#r\xe9glementations%# et l'%#obligation d'information%# de Przelewy24",
    ...
    "ctp.infoPopup.subtitle":
        "Un mode de paiement rapide et s\xe9curis\xe9 compatible avec les cartes Mastercard, Visa et autres fournisseurs.",
    ...
    "ctp.errors.NOT_FOUND":
        "Aucun compte trouv\xe9, v\xe9rifiez l'adresse e-mail ou saisissez manuellement les informations de votre carte",
    ...
    "ctp.errors.RETRIES_EXCEEDED":
        "La limite du nombre de tentatives pour la g\xe9n\xe9ration de l'OTP a \xe9t\xe9 d\xe9pass\xe9e",
    "ctp.errors.OTP_SEND_FAILED": "Impossible d'envoyer l'OTP au destinataire",
    "ctp.errors.REQUEST_TIMEOUT":
        "Une erreur s'est produite, r\xe9essayez ou saisissez manuellement les informations de votre carte",
    ...
    "trustly.description1":
        "Payez directement \xe0 partir de n'importe lequel de vos comptes bancaires, avec une s\xe9curit\xe9 de niveau bancaire",
