    ...
    let e = T((e) => e.enabled),
        ...
        l = o.useCallback(
            async (t) => {
                ...
                null != a ? w(`recorder ${a.enabled ? "enabled" : "disabled"}`) : O(e);
            },
            [n, e],
        ),
                ...
                (0, r.jsxs)(u.n, {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(x.$, {
                            ...
                            onClick: () => {
                                A.Ts({ type: L.Gy.GAME_EVENT, eventType: O, importance: w, title: G, description: F });
                            },
                        }),
                        (0, r.jsx)(m.d, {
...
let e9 = (e) => {
        let { profileEffect: t } = e,
            ...
            A = c ? eW.A.themes.DARK : eW.A.themes.LIGHT;
        function k(e) {
...
let tw = (e) => {
        ...
        return (
            ...
            (0, r.jsx)("div", { className: tR.Do, children: (0, r.jsx)(tN.A, { ...e }, t) })
        );
    },
    tM = () => {
                                    ...
                                    ? (0, r.jsxs)("div", {
                                          ...
                                          children: [
                                              ...
                                              (0, r.jsx)(x.$, {
                                                  variant: "primary",
                                                  onClick: function () {
                                                      null != h && null != e && tO({ skuId: h.skuId, sender: e });
                                                  },
    ...
    let l = e?.entries?.flatMap((e) => {
        ...
        return (0, r.jsxs)(
            "li",
            {
                className: t5.p,
                children: [
                    (0, r.jsx)(t8, { type: l.author_type, id: l.author_id }),
...
function aL() {
    let { unreadRecentMentionsCount: e, unreadChannelIds: t } = (0, aO.U4)(),
        {
            isLoading: a,
            hasLoadedEver: n,
            hasPreloaded: l,
...
function nd() {
    ...
    let t,
        a,
        n = o.useRef(null),
        { analyticsLocations: l } = (0, a8.Ay)(t_.A.DEV_TOOLS),
        [i, s] = o.useState(""),
                        ...
                        children: [
                            ...
                            (0, r.jsxs)(p.E, {
                                ...
                                children: [
                                    ...
                                    " ",
                                    y.length > 0
                                        ? y.map((e) => ((0, a4.t)(v)?.id === e.id ? `${e.name}*` : e.name)).join(", ")
                                        : "N/A",
                                ],
                            }),
                        ],
    ...
    TRACK: function (e) {
        ...
        aq.A.isDeveloper &&
            (nw.push({
                ...
                event: t,
                properties: a,
                fingerprint: null != n ? (0, nT.d)(n) : nO.default.getId(),
                timestamp: new Date(),
            }),
            nM++,
    ...
    return (0, r.jsx)(g.Ar, {
        children: (0, r.jsxs)(W.B, {
            ...
            children: [
                ...
                (0, r.jsx)(n8, {}),
                (0, r.jsx)(b.c, {}),
                (0, r.jsx)(n4, { configs: a, selectedConfigId: e, onSelectConfig: t }),
...
async function sd(e, t) {
    return await st.A.get({
        ...
        trackedActionData: { event: i4.NetworkActionNames.USER_LOGIN },
        rejectWithError: !1,
    })
        .then((e) => {
            let { ok: a, body: n } = e;
...
function sp(e) {
    let { pool: t } = e,
        ...
        i = (0, d.bG)([nO.default], () => nO.default.getId()),
                                                    ...
                                                    children: [
                                                        ...
                                                        i === e.id
                                                            ? (0, r.jsx)(p.E, {
                                                                  ...
                                                                  children: (0, r.jsx)(i5.y, {
                                                                      size: "sm",
                                                                      color: "currentColor",
                                                                  }),
                                                              })
                                                            : (0, r.jsx)(i8._, { size: "sm", color: "currentColor" }),
                                                    ],
                                                },
                                                e.id,
                                            ),
...
function sC() {
    ...
    let I = u.filter((e) => e.intent_type === sE),
        ...
        R = O.map((e) => ({ id: e, value: e, label: en.default.getUser(e)?.username ?? `Unknown User (${e})` })),
        w = y || _;
    function M(e) {
...
let sR = [0, 0.5, 1],
    ...
    s$ = [
        ...
        { label: "Ash", value: er.NJ8.ASH, id: er.NJ8.ASH },
        { label: "Dark", value: er.NJ8.DARK, id: er.NJ8.DARK },
        { label: "Onyx", value: er.NJ8.ONYX, id: er.NJ8.ONYX },
    ],
    sV = { [er.NJ8.ASH]: er.NJ8.DARK, [er.NJ8.ONYX]: er.NJ8.DARK, [er.NJ8.LIGHT]: er.NJ8.DARK },
    sW = { [er.NJ8.LIGHT]: "light", [er.NJ8.ASH]: "ash", [er.NJ8.DARK]: "dark", [er.NJ8.ONYX]: "onyx" },
    sz = [
...
function sX(e) {
    ...
    return (0, r.jsxs)(W.B, {
        ...
        children: [
            ...
            (0, r.jsx)("pre", { className: sO.RP, children: t }),
        ],
    });
}
function sZ(e) {
...
function s6() {
    return {
        [er.NJ8.LIGHT]: s3(),
        [er.NJ8.ASH]: { colors: [...sU], scales: [...sG], opacities: [...sB] },
        [er.NJ8.DARK]: s3(),
        [er.NJ8.ONYX]: s3(),
    };
}
    ...
    let e = (0, sS.G9)(),
        ...
        C = o.useMemo(() => {
            ...
            for (let t = 0; t < sM; t++) {
                ...
                e.push({ color: y.colors[t], opacity: a, position: sR[t] });
            }
            return e;
        }, [y]),
        S = o.useMemo(() => {
            ...
            try {
                return s$.map((e) => {
                    ...
                    for (let e = 0; e < sM; e++) {
                        ...
                        l.push({ color: n.colors[e], opacity: i, position: sR[e] });
                    }
                    return {
                        theme: t,
                        label: a,
            ...
            children: [
                ...
                (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(x.$, { variant: "primary", text: "Reset", onClick: s4.O }),
                    ],
                }),
                (0, r.jsxs)("div", {
                    className: rs.uW,
    ...
    EmailPincodeModal: async () => {
        ...
        return (t) =>
            (0, r.jsx)(e, {
                ...
                impression: { impressionName: i4.ImpressionNames.URF_CONFIRM_EMAIL_CODE },
            });
    },
                    ...
                    children: [
                        ...
                        (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(x.$, {
                                ...
                                text: "Open",
                                onClick: function () {
                                    ((0, r6.o)(!0), r8._.dispatch(er.jej.PREMIUM_SUBSCRIPTION_CREATED));
                                },
                            }),
                        }),
                    ],
...
function ov() {
    let [e, t] = o.useState([]),
        ...
        { entitlements: D, deleteFractionalPremium: T, refreshEntitlementList: O } = ib();
    async function R() {
...
let de = o.memo(function (e) {
    ...
    dl = o.memo(function () {
        let [e, t] = o8(er.uss.CLICK_ZONE_DEBUG),
            [a, n] = o8(er.uss.PERFORMANCE_DEBUG),
...
let d1 = function () {
    let [e, t] = o.useState(tD.pe.TIER_2),
        ...
        [i] = (0, d.yK)([r5.A], () => [r5.A.getPremiumSubscription()]),
        ...
        { analyticsLocations: N } = (0, a8.Ay)(t_.A.PAYMENT_FLOW_TEST_PAGE),
        [A, k] = o.useState(""),
        [I, D] = o.useState(er.dJq),
        { balance: T, isFetching: O, error: R } = (0, dQ.W)(),
...
function cc(e) {
    let { experimentName: t, options: a = cr } = e,
        n = (0, tE.bG)([d8.A, nO.default], () => {
            let e = nO.default.getId(),
                a = d8.A.getAssignment("user", e, t);
            return a?.isOverride === !0 ? String(a.variantId) : "none";
        }),
        l = o.useCallback(
            (e) => {
                (0, d5.t$)(d5.l5.APEX, t, "none" === e ? null : Number(e));
            },
            [t],
        );
...
function cu() {
    return (0, r.jsxs)(W.B, {
        ...
        children: [
            ...
            (0, r.jsx)(cc, { experimentName: d4.A.definition.name, options: cd }),
        ],
    });
}
let cm = [
...
var cO = a(873298),
    ...
    cB = a(385803),
    cF = a(381941);
let c$ = [er.NJ8.ASH, er.NJ8.LIGHT, er.NJ8.DARK, er.NJ8.ONYX],
...
async function cz() {
    ...
    try {
        if (a) {
            ...
            } else e = cW([er.NJ8.ASH, er.NJ8.DARK, er.NJ8.ONYX]);
            await cP.u_(
...
function cY() {
    ...
    let e = (0, d.bG)([en.default], () => en.default.getCurrentUser()),
        ...
        j = (0, d.bG)([cR.Ay], () => cR.Ay.fontSize),
        f = (0, d.bG)([cR.Ay], () => cR.Ay.messageGroupSpacing),
        b = cM.Xi.useSetting();
    return (
        o.useEffect(() => {
              ...
              children: [
                  ...
                  (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsx)(x.$, {
                          ...
                          onClick: () => (0, c8.$)("fortnite", "DevTools Quick Actions"),
                      }),
                  }),
                  (0, r.jsx)("div", {
                      className: F()(us.N, ur.QB),
                    ...
                    async (e) => {
                        try {
                            ...
                            ((function (e) {
                                ...
                                await Promise.all([u8(n, s), u4(n, s)]));
                        } finally {
                            t(!0);
                        }
                    },
        ...
        children: () =>
            (0, r.jsxs)("button", {
                ...
                children: [
                    ...
                    (0, r.jsx)(i8._, { size: "sm", color: "currentColor", className: F()(mS.ai, { [mS.hg]: a }) }),
                ],
            }),
    });
}
...
var mw = a(209612);
function mM() {
    return (0, r.jsx)("div", { className: mw.n, children: (0, r.jsx)(mR, {}) });
}
var mL = a(278416),
    mP = a(53938);
function mU(e, t) {
        ...
        (this.waitFor(aq.A),
            ...
            m5 ||
                C.Ay.addChangeListener(function e() {
                    m8() && (m4(), C.Ay.removeChangeListener(e));
                }));
    }
...
function hk() {
    let [e, t] = o.useState(!1),
        a = (0, d.bG)([en.default], () => en.default.getCurrentUser()),
        n = (0, hN.Lh)(),
        l = (0, d.bG)([r5.A], () => r5.A.getPremiumTypeSubscription()),
...
let hR = {
    ...
    hw = {
        [hO.qf.UNKNOWN]: "Unknown",
        [hO.qf.ADMIN]: "Admin",
        [hO.qf.USER]: "User",
        [hO.qf.FRACTIONAL_PREMIUM]: "Fractional Premium",
        [hO.qf.DEFERRED_START]: "Deferred Start",
        [hO.qf.USER_TEMPORARY_BAN]: "User Temp Ban",
    },
    hM = [
...
function hL(e) {
    ...
    async function v() {
        ...
        (h(!0), g(void 0));
        try {
            (await hT(t.id, hD.TIME_TRAVEL, { targetDate: s, paymentType: hI.DEFAULT, sendReminderEmail: !1 }),
                n(),
                a());
        } catch (e) {
...
function hP(e) {
    let { subscription: t } = e,
        ...
        { analyticsLocations: n } = (0, a8.Ay)(t_.A.PAST_DUE_ONE_TIME_PAYMENT_METHOD_BANNER);
...
function hF() {
    let e = (0, d.bG)([r5.A], () => r5.A.getPremiumTypeSubscription()),
...
var xk = a(913122),
    ...
    xP = a(149790),
    xU = a(926140);
let xG = new xO.A("SearchDebugUtils");
function xB() {
    xG.info("--------------------------");
}
function xF() {
...
function xX() {
    let e = xQ.useField("isRecording"),
        ...
        i = o.useRef(""),
        s = o.useCallback(() => {
            let { results: e, query: t } = xR.A.getProps();
            (l.current !== e || i.current !== t) && ((l.current = e), (i.current = t), xF());
        }, []);
    o.useEffect(() => {
        if (e) return (xR.A.addChangeListener(s), () => xR.A.removeChangeListener(s));
    }, [s, e]);
...
function x2(e) {
    let { userState: t } = e,
        ...
        s = o.useCallback((e) => {
            let { ok: t } = e;
            return t
                ? (0, r.jsx)(i5.y, { size: "sm", color: eW.A.colors.STATUS_POSITIVE })
...
let pi = [
    ...
    ps = {
        ...
        nitro: function () {
            return (0, r.jsxs)("div", { children: [(0, r.jsx)(x4.o, {}), (0, r.jsx)(x9.A, {}), (0, r.jsx)(x7.A, {})] });
        },
    };
function pr() {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)(x8.V, {
                ...
                type: "top",
                orientation: "horizontal",
                children: pi.map((e) => (0, r.jsx)(x8.V.Item, { id: e.id, children: e.name }, e.id)),
            }),
